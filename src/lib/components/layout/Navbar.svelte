    ...
    <div class="flex items-center justify-between h-20">
      ...
      <div class="hidden lg:flex lg:items-center lg:space-x-8">
        ...
        <div class="flex items-center space-x-4">
          <a
            href="#/drop-cv"
            class="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-lg shadow-md text-white bg-gradient-to-r from-primary-500 to-primary-700 hover:from-primary-600 hover:to-primary-800 transform hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 relative overflow-hidden group"
          >
    ...
    <div class="lg:hidden absolute top-20 inset-x-0 bg-white shadow-lg">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <div class="px-3 py-2">
          <a
            href="#/drop-cv"
            class="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-lg shadow-md text-white bg-gradient-to-r from-primary-500 to-primary-700 hover:from-primary-600 hover:to-primary-800 transform hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 relative overflow-hidden group w-full justify-center"
          >
            <span class="absolute inset-0 w-full h-full bg-white/10 group-hover:bg-white/20 transition-all duration-300"></span>
            <span class="relative flex items-center">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
