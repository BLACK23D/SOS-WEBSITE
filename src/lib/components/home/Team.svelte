...
<script lang="ts">
  ...
  const teamMembers = [
    {
      ...
      image: '/src/lib/assets/images/SOS-Recruits-CEO-Jane-Mwaura.png',
      bio: 'Over 15 years of experience in international recruitment.',
      social: {
    ...
    },
    {
      name: 'Mr Andrew',
      role: 'Director',
      image: '/src/lib/assets/images/Mr Andrew Director..jpeg',
      bio: 'Experienced director overseeing strategic operations and growth.',
      social: {
        linkedin: 'https://linkedin.com',
        twitter: 'https://twitter.com',
        instagram: 'https://instagram.com'
    ...
    },
    {
      ...
      image: '/src/lib/assets/images/SOS-Recruits-Waithera.png',
      bio: 'Expert in healthcare and hospitality recruitment.',
      social: {
        linkedin: 'https://linkedin.com',
        twitter: 'https://twitter.com',
        instagram: 'https://instagram.com'
    ...
    {
      name: 'Susan',
      role: 'Head of Local Recruitment',
      image: '/src/lib/assets/images/SOS-Recruits-Susan.png',
      bio: 'Specialized in local market recruitment with extensive industry network.',
      social: {
        linkedin: 'https://linkedin.com',
        twitter: 'https://twitter.com',
        instagram: 'https://instagram.com'
  ...
  let loaded = Array(teamMembers.length).fill(false);
  ...
  function handleImageError(index: number) {
    ...
    teamMembers[index].image = '/src/lib/assets/images/team/placeholder.jpg';
  }
</script>
