...
{#if currentNews}
  <article class="py-16 bg-gray-50 dark:bg-gray-900" transition:fade>
          ...
          {#each formatContent(currentNews.content) as line}
            ...
            {:else if isListItem(line)}
              <div class="flex items-start gap-2 mb-2">
                <span class="text-blue-600 dark:text-blue-400 mt-1.5">•</span>
          ...
          <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="flex flex-wrap gap-2">
              {#each currentNews.tags as tag}
                <a
                  href="/news?tag={tag}"
                  class="px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200"
                >
                  {tag}
                </a>
              {/each}
...
{:else}
  <div class="py-16 bg-gray-50 dark:bg-gray-900 min-h-screen" transition:fade>
    <div class="container mx-auto px-4">
